...
export default function Footer() {
  return (
    <footer className="relative pt-20 pb-10 section-padding border-t border-gray-200/50">
      <div className="gradient-blob w-[400px] h-[400px] bg-primary-100 -bottom-40 left-1/2 -translate-x-1/2 opacity-30" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-ink-secondary leading-relaxed max-w-xs mb-6">
              AI-powered adaptive onboarding that personalizes every employee's learning journey.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-surface hover:bg-primary-50 flex items-center justify-center text-ink-muted hover:text-primary-600 transition-all duration-200"
                >
                  {social.icon}
                </a>
              ))}
