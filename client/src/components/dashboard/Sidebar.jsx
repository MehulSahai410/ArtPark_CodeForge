...
import { Home, Map, Library, Target, Award, MessageSquare } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const sections = [
    ...
    },
    {
      title: 'Learning',
      items: [
        { label: 'My Roadmap', path: '/dashboard/roadmap', icon: Map },
        { label: 'Module Library', path: '/dashboard/modules', icon: Library, badge: 'New' },
        { label: 'Skill Gap Report', path: '/dashboard/skill-gap', icon: Target },
      ]
    },
    {
      title: 'Milestones',
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 glass-effect border-r border-white/60 bg-white/40 flex flex-col z-50 animate-fade-in-left hidden lg:flex">
      <div className="p-6 border-b border-gray-100/50">
        <Link to="/" className="flex items-center gap-2">
          {/* Reusing landing page Nav logo style */}
